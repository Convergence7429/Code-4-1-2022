...
public class Shooter {
    ...
    public boolean centerRobotOnTarget() {
        ...
        if (xAngle < -15.0) {
            Robot.drive.mecanumDrive.driveCartesian(Robot.drive.driveSpeedCoefficient * -ySpeed * ySpeed * yDirectionMaintainer, (Robot.drive.driveSpeedCoefficient + 0.1) * xSpeed * xSpeed * xDirectionMaintainer, -0.2);
            return false;
        } else if (xAngle > 15.0) {
            Robot.drive.mecanumDrive.driveCartesian(Robot.drive.driveSpeedCoefficient * -ySpeed * ySpeed * yDirectionMaintainer, (Robot.drive.driveSpeedCoefficient + 0.1) * xSpeed * xSpeed * xDirectionMaintainer, 0.2);
            return false;
        } else if (xAngle < -4.0) {
            Robot.drive.mecanumDrive.driveCartesian(Robot.drive.driveSpeedCoefficient * -ySpeed * ySpeed * yDirectionMaintainer, (Robot.drive.driveSpeedCoefficient + 0.1) * xSpeed * xSpeed * xDirectionMaintainer, -0.12);
            return false;
        } else if (xAngle > 4.0) {
            Robot.drive.mecanumDrive.driveCartesian(Robot.drive.driveSpeedCoefficient * -ySpeed * ySpeed * yDirectionMaintainer, (Robot.drive.driveSpeedCoefficient + 0.1) * xSpeed * xSpeed * xDirectionMaintainer, 0.12);
            return false;
        } else if (xAngle < -1.0) {
            Robot.drive.mecanumDrive.driveCartesian(Robot.drive.driveSpeedCoefficient * -ySpeed * ySpeed * yDirectionMaintainer, (Robot.drive.driveSpeedCoefficient + 0.1) * xSpeed * xSpeed * xDirectionMaintainer, -0.06);
            return false;
        } else if (xAngle > 1.0) {
            Robot.drive.mecanumDrive.driveCartesian(Robot.drive.driveSpeedCoefficient * -ySpeed * ySpeed * yDirectionMaintainer, (Robot.drive.driveSpeedCoefficient + 0.1) * xSpeed * xSpeed * xDirectionMaintainer, 0.06);
            return false;
        } else {
            Robot.drive.mecanumDrive.driveCartesian(Robot.drive.driveSpeedCoefficient * -ySpeed * ySpeed * yDirectionMaintainer, (Robot.drive.driveSpeedCoefficient + 0.1) * xSpeed * xSpeed * xDirectionMaintainer, 0.0);
            return true;
        }
    }
    ...
    public void dumpShotLEDs() {
        ...
        if ((distance > 32.0) && (distance < 55.0)) {
